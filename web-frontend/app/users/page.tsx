                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <button
                            ...
                            className={`inline-flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-colors ${showInactive
                        ...
                        >
                            ...
                            {showInactive ? 'Voir actifs' : 'Voir inactifs'}
                        </button>
                        <button
                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {users
                                .filter(userItem => showInactive ? !userItem.is_active : userItem.is_active)
                                .map((userItem) => (
